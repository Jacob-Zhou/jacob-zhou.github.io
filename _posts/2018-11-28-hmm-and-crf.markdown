...
![markov-chains](\img\hmm-and-crf\markov-chains.png)

下面是该马尔可夫链可能生成的一条状态随机序列

![state-sequence](\img\hmm-and-crf\state-sequence.png)

在隐马尔可夫模型中，我们假设由马尔可夫链生成的隐藏状态我们是无法直接观测到的，我们只能够观察到由这些隐藏状态随机生成的观测量。

![hmm-model](\img\hmm-and-crf\hmm-model.svg)
...
![hmm-pos-model](\img\hmm-and-crf\hmm-pos-model.png)
...
![condition-block](\img\hmm-and-crf\condition-block.png)
...
![crf-model](\img\hmm-and-crf\crf-model.png)
